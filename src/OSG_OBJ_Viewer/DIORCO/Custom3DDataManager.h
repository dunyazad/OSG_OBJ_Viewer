...
public:
	...
	static void SaveObjFile(ref_ptr<Vec3Array> pVertices, const string& objFileName, bool isBinary = false);
	static void SaveSTLFile(ref_ptr<Vec3Array> pVertices, const string& objFileName, bool isBinary = false);
	static void SaveObjFile(RAW_DATA_INFO &sRawDataInfo, const string& objFileName, bool isBinary = false);
	static void SaveSTLFile(RAW_DATA_INFO &sRawDataInfo, const string& objFileName, bool isBinary = false);
};